                ...
                <div class="col-12 navigation-wrapper">
                    <div class="nav-inner">
                        <ul class="list-inline">
                            ...
                            @endif
                            <li class="nav-item">
                                <a href="{{ url('profile') }}" class="nav-link"><i class="fas fa-user"></i>My
                                    PROFILE</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.work')}}" class="nav-link"><i class="fas fa-tasks-alt"></i>How
                                    it works</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.guidelines')}}" class="nav-link"><i
                                        class="fas fa-file-alt"></i>Guidelines</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.faq')}}" class="nav-link"><i
                                        class="fas fa-question"></i>FAQs</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.gifting-forms')}}" class="nav-link"><i
                                        class="fas fa-gift"></i>Gifting Forms</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.privacy-statement')}}" class="nav-link"><i
                                        class="fas fa-user-secret"></i>Privacy Statement</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('front.contact-us')}}" class="nav-link"><i
