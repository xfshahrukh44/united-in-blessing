                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{isset($attribute->id) ? 'Edit' : 'Add'}} FAQS</h3>
                            </div>
                            <form class="attribute-form" method="post" action="{{ route('faq.store') }}" enctype="multipart/form-data">
                                  {{-- route('catalog.editAttribute', $attribute->id) --}}
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="title" id="title" placeholder="Faqs title" required>
                                            </div>
                                        </div>
                                    </div>
