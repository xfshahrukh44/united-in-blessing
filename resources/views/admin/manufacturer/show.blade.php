...
@section('title', 'Manufacturer Detail')
@section('page_css')
    <!-- Datatables -->
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 offset-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Manufacturer Detail</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <td colspan="4">{{$manufacturer->name ?? ''}}</td>
                                        </tr>
                                        <tr>
                                            <th>Sort Order</th>
                                        ...
                                        <tr>
                                            <th>Image</th>
                                            <td colspan="4"><img src="{{manufacturerImage($manufacturer->image) ?? ''}}"></td>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
