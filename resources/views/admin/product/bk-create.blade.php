...
{{--                                <h3 class="card-title">Product</h3>--}}
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#galleryImages" role="tab" data-toggle="tab">Gallery Images</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                {{-- <div class="col">
                                                    ...
                                                    <input type="text" name="length" placeholder="Length" class="form-control" id="length"  value="{{old('length')}}">
                                                </div> --}}
                                                <div class="col">
                                                    <label for="exampleInputEmail1">Width</label>
                                                    <input type="text" name="width" class="form-control" placeholder="Width" id="width" value="{{old('width')}}">
                                                </div>
                                                {{-- <div class="col">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="text" name="weight" class="form-control" id="weight" value="{{old('weight')}}" placeholder="Weight">
                                                </div> --}}
                                            </div>
                                            <br>
                                            <div class="row">
...
--}}{{--                                                <td></td>--}}{{--
                                ...
                                <div class="tab-pane" role="tabpanel" id="options">
                                    <div class="col-md-12 text-right">
...
--}}{{--                                            </tr>--}}{{--
                                ...
                                <div class="tab-pane" role="tabpanel" id="related_products">
                                    <div class="col-md-12 text-right">
