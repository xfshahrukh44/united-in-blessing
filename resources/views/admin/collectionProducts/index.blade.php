                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Collection Products</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="btn btn-primary pull-right addBtn" href="{{route('collectionProducts.create')}}">Add Collection Products</a>
                            </div>
                            <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            var DataTable = $("#example1").DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: `{{route('collectionProducts.index')}}`,
                },
                columns: [
                    {data: 'id', name: 'id'},
