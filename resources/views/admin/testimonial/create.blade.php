...
@section('title', isset($attribute->id) ? 'Edit Testimonial' : 'Add Testimonial')
@section('section')
    <style>
        .switch {
            position: relative;
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{isset($attribute->id) ? 'Edit' : 'Add'}} Testimonial</h3>
                            </div>
                            <form class="attribute-form" method="post" action="{{ route('testimonial.store') }}" enctype="multipart/form-data">
