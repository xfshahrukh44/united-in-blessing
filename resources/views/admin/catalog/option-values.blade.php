                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-primary pull-right addBtn" href="{{route('catalog.addOptionValue')}}">Add Option Value</a>
                            </div>
                            <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            var DataTable = $("#example1").DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: `{{route('catalog.optionValues')}}`,
                },
                columns: [
                    {data: 'id',            name: 'id'},
            ...
            $(document).on('click','#ok_delete',function(){
                $.ajax({
                    url:"{{url('admin/catalog/destroy-option-value')}}/"+delete_id,
                    type:'post',
                    data:{
                        id:delete_id,
                        "_method": 'DELETE',
