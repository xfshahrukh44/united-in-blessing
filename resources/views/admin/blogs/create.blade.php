                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            ...
                            <form class="category-form" method="post" action="{{route('blog.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    @if(Session::has('msg'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{old('title')}}" placeholder="Blog Title" required>
                                        @error('title')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <img src="{{asset('admin/images/placeholder.png')}}" alt="" id="img" style="height: 200px;width: 200px;">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
