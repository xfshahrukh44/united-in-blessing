...
<div class="indexHeader"><?php include 'layout/nav.php'; ?></div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5">
                <div class="inviterCard">
                    <img src="images/inviter.jpg" alt="">
                    <h4>Big_Giver</h4>
                    <p>Barbara Harris</p>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="inviterCard invitees">
                    <img src="images/invite-1.jpg" alt="">
                    <h4>Sarah_Jones</h4>
                    <p>Barbara Harris</p>
            ...
            <div class="col-lg-3">
                <div class="inviterCard invitees">
                    <img src="images/invite-2.jpg" alt="">
                    <h4>Barbara_Smith</h4>
                    <p>Barbara Harris</p>
                    <a href="tel:3237777654"><i class="fa fa-phone"></i> 323-777-7654</a>
                    <a href="mailto:email@uib.com"><i class="fa fa-envelope"></i> email@uib.com</a>
            ...
            <div class="col-lg-3">
                <div class="inviterCard invitees">
                    <img src="images/invite-3.jpg" alt="">
                    <h4>Sarah_Jones</h4>
                    <p>Barbara Harris</p>
                    <a href="tel:3237777654"><i class="fa fa-phone"></i> 323-777-7654</a>
                    <a href="mailto:email@uib.com"><i class="fa fa-envelope"></i> email@uib.com</a>
            ...
            <div class="col-lg-3">
                <div class="inviterCard invitees">
                    <img src="images/invite-4.jpg" alt="">
                    <h4>Barbara_Smith</h4>
                    <p>Barbara Harris</p>
                    <a href="tel:3237777654"><i class="fa fa-phone"></i> 323-777-7654</a>
                    <a href="mailto:email@uib.com"><i class="fa fa-envelope"></i> email@uib.com</a>
